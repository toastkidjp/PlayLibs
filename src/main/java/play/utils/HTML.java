...
public class HTML {
    ...
    public static String htmlEscape(final String input) {
        ...
        final StringBuffer escaped = new StringBuffer(input.length() * 2);
    ...
    public static class HtmlCharacterEntityReferences {
        ...
        public HtmlCharacterEntityReferences() {
            ...
            final InputStream is = HtmlCharacterEntityReferences.class.getResourceAsStream(PROPERTIES_FILE);
            if (is == null) {
        ...
        public String convertToReference(final char character) {
            if (character < 1000 || (character >= 8000 && character < 10000)) {
                final int index = (character < 1000 ? character : character - 7000);
