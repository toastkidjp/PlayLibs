...
public class Lang {
     ...
     */
    public static boolean set(final String locale) {
     ...
     */
    private static String findClosestMatch(final Collection<String> desiredLocales) {
        final ArrayList<String> cleanLocales = new ArrayList<String>(desiredLocales.size());
        //look for an exact match
        for (String a: desiredLocales) {
            a = a.replace("-", "_");
            cleanLocales.add(a);
            for (final String locale: Play.langs) {
        ...
        for (String a: cleanLocales) {
            final int splitPos = a.indexOf("_");
            if (splitPos > 0) {
                a = a.substring(0, splitPos);
            }
            for (final String locale: Play.langs) {
                String langOnlyLocale;
                final int localeSplitPos = locale.indexOf("_");
                if (localeSplitPos > 0) {
    ...
    public static Locale getLocaleOrDefault(final String localeStr) {
     ...
     public static Locale getLocale(final String localeStr) {
        ...
        final int splitPos = lang.indexOf("_");
        if (splitPos > 0) {
