...
public abstract class Cache {
     ...
     */
    public static void add(final String key, final Object value, final String expiration) {
     ...
     */
    public static boolean safeAdd(final String key, final Object value, final String expiration) {
        checkSerializable(value);
     ...
     * @param expiration Ex: 10s, 3mn, 8h
     */
    public static void set(final String key, final Object value, final String expiration) {
        checkSerializable(value);
     ...
     * @return If the element an eventually been cached
     */
    public static boolean safeSet(final String key, final Object value, final String expiration) {
        checkSerializable(value);
     ...
     * @param expiration Ex: 10s, 3mn, 8h
     */
    public static void replace(final String key, final Object value, final String expiration) {
        checkSerializable(value);
     ...
     * @return If the element an eventually been cached
     */
    public static boolean safeReplace(final String key, final Object value, final String expiration) {
        checkSerializable(value);
     ...
     * @param value Element value
     */
    public static void replace(final String key, final Object value) {
        checkSerializable(value);
     ...
     */
    public static long incr(final String key, final int by) {
     ...
     * @return The new value
     */
    public static long decr(final String key, final int by) {
     ...
     */
    public static Map<String, Object> get(final String... key) {
        return cacheImpl.get(key);
    }
     ...
     */
    public static boolean safeDelete(final String key) {
     ...
     */
    static void checkSerializable(final Object value) {
